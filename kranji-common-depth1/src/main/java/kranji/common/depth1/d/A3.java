...
public final class A3 {
    ...
    public static final ComposedZi DA_HIT = new ComposedZi(
            new ZiChar.Unicode("\u6253"),
            new PinyinSyllable(Initial.D, new Final(Head.OPEN, Body.A, Tail.NONE), Tone.THIRD),
            5, 64, "",
            new LeftRight(BasicComponents.TI_SHOU_PANG, ToolsAndVessels.DING_NAIL),
            new PhonoSemantic(BasicComponents.TI_SHOU_PANG, ToolsAndVessels.DING_NAIL));
