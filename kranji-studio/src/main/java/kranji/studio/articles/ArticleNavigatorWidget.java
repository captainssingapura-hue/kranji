...
public final class ArticleNavigatorWidget
    ...
    protected List<String> constructBodyJs() {
        return List.of(
                ...
                "                    // A resync is a pane catching up, so the root it names",
                "                    // is usually the one already showing and there is",
                "                    // nothing to do. An explicit pick is not: clicking the",
                "                    // folder you are already looking at means look again,",
                "                    // and swallowing that left the tree stale for as long",
                "                    // as it took somebody to notice the file they had just",
                "                    // written was missing.",
                "                    if (msg.what === 'resync' && (msg.root || '') === rootId) return;",
                "                    rootId = msg.root || '';",
                "                    load();",
                "                }",
                "            }",
