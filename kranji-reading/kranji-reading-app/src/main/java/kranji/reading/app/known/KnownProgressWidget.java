...
public final class KnownProgressWidget
    ...
    protected List<String> constructBodyJs() {
        return List.of(
                ...
                "                var here = progress.bandOf(progress.count(known.record()));",
                ...
                "",
                "    function showDetail() {",
                "        var n = progress.count(known.record());",
                ...
                "    }",
                "",
                "    // This pane keeps listening, because answering a claim costs it one",
                "    // number. That is the line: a pane whose response to an event is",
                "    // cheap may subscribe, and a pane that would have to measure the",
                "    // whole library to answer must not - which is why the Library no",
                "    // longer shows readability and this still shows a count.",
                ...
                "        partyDeregister: function () { known.leave(); }",
                "    };"
        );
    }
}
