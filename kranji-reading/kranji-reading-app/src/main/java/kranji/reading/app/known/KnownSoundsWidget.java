...
public final class KnownSoundsWidget
    ...
    protected List<String> constructBodyJs() {
        return List.of(
                ...
                "                    if (!__settled) render();",
                "                },",
                "                // Rewritten from outside the bus - an import, a replace.",
                "                // The message says that it happened and not what it is",
                "                // now, so read the device, which is the only thing that",
                "                // knows.",
                "                //",
                "                // This one does redraw, settled or not. A claim moves one",
                "                // count and is not worth 1,288 rows; a record replaced",
                "                // wholesale moves most of them, and happens twice a year.",
