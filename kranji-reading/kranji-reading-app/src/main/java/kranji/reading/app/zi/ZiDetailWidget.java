...
public final class ZiDetailWidget extends WorkspaceWidget<WorkspaceWidget._None, ZiDetailWidget> {
    ...
    protected List<String> constructBodyJs() {
        return List.of(
                ...
                "",
                "    // At the top, beside what it changes, and only present when it would",
                "    // change something. One grid rather than two: a second grid holding",
                "    // the same rows plus one meant a second header, and a header repeated",
                "    // down the pane is the densest thing here that says nothing.",
