...
public final class ZiCharactersWidget extends WorkspaceWidget<WorkspaceWidget._None, ZiCharactersWidget> {
    ...
    protected List<String> constructBodyJs() {
        return List.of(
                ...
                "    }",
                "",
                "    // The canonical reading this pane is listing, carried into the",
                "    // selection so the Character pane can open on the sound that was",
                "    // actually clicked rather than on all of them.",
                "    var __syllable = '';",
                "",
                ...
                "            .then(function (mod) {",
                "                // Canonical, off the module - not the address in namePath,",
                "                // which spells the same sound differently.",
                "                __syllable = mod.syllable || '';",
                "                render(mod, seq);",
                "            })",
                "            .catch(function (err) {",
                "                if (seq !== __seq) return;",
