...
public final class Depth2StrokesHigh {
    ...
    public static final ComposedZi BAN_BOARD = new ComposedZi(
            lit("\u677F"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.N, Tone.THIRD)),
    ...
    public static final ComposedZi FAN_PEDDLE = new ComposedZi(
            lit("\u8D29"), List.of(py(Initial.F, Head.OPEN, Body.A, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi BAN_EDITION = new ComposedZi(
            lit("\u7248"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.N, Tone.THIRD)),
    ...
    public static final ComposedZi WAN_PLAY = new ComposedZi(
            lit("\u73A9"), List.of(py(Initial.ZERO, Head.U, Body.A, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi SONG_PINE = new ComposedZi(
            lit("\u677E"), List.of(py(Initial.S, Head.OPEN, Body.O, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi BAO_HUG = new ComposedZi(
            lit("\u62B1"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi PAO_BUBBLE = new ComposedZi(
            lit("\u6CE1"), List.of(py(Initial.P, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi BAO_FULL = new ComposedZi(
            lit("\u9971"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.THIRD)),
    ...
    public static final ComposedZi DAN_CARRY = new ComposedZi(
            lit("\u62C5"), List.of(py(Initial.D, Head.OPEN, Body.A, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi TAN_FLAT = new ComposedZi(
            lit("\u5766"), List.of(py(Initial.T, Head.OPEN, Body.A, Tail.N, Tone.THIRD)),
    ...
    public static final ComposedZi ZHAO_BECKON = new ComposedZi(
            lit("\u62DB"), List.of(py(Initial.ZH, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FIRST)),
    ...
    public static final ComposedZi JU_ARREST = new ComposedZi(
            lit("\u62D8"), List.of(py(Initial.J, Head.V, Body.V, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi GOU_DOG = new ComposedZi(
            lit("\u72D7"), List.of(py(Initial.G, Head.OPEN, Body.O, Tail.VOWEL_U, Tone.THIRD)),
    ...
    public static final ComposedZi DIAN_SHOP = new ComposedZi(
            lit("\u5E97"), List.of(py(Initial.D, Head.I, Body.A, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi ZHAN_MOISTEN = new ComposedZi(
            lit("\u6CBE"), List.of(py(Initial.ZH, Head.OPEN, Body.A, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi TIE_CARD = new ComposedZi(
            lit("\u5E16"), List.of(py(Initial.T, Head.I, Body.E, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi FU_INSTRUCT = new ComposedZi(
            lit("\u5490"), List.of(py(Initial.F, Head.U, Body.U, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi FU_MANSION = new ComposedZi(
            lit("\u5E9C"), List.of(py(Initial.F, Head.U, Body.U, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi TUO_CAMEL = new ComposedZi(
            lit("\u9A7C"), List.of(py(Initial.T, Head.U, Body.O, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi NE_PARTICLE = new ComposedZi(
            lit("\u5462"), List.of(py(Initial.N, Head.OPEN, Body.E, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi NI_MUD = new ComposedZi(
            lit("\u6CE5"), List.of(py(Initial.N, Head.OPEN, Body.I, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi SHI_SERVE = new ComposedZi(
            lit("\u4F8D"), List.of(py(Initial.SH, Head.OPEN, Body.I, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi SHI_POETRY = new ComposedZi(
            lit("\u8BD7"), List.of(py(Initial.SH, Head.OPEN, Body.I, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi ZHI_WEAVE = new ComposedZi(
            lit("\u7EC7"), List.of(py(Initial.ZH, Head.OPEN, Body.I, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi PIN_POOR = new ComposedZi(
            lit("\u8D2B"), List.of(py(Initial.P, Head.OPEN, Body.I, Tail.N, Tone.SECOND)),
