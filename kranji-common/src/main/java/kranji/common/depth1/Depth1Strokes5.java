...
public final class Depth1Strokes5 {
    ...
    public static final ComposedZi KAN = new ComposedZi(
            uni("\u520A"), py(Initial.K, Head.OPEN, Body.A, Tail.N, Tone.FIRST),
    ...
    public static final ComposedZi DA_HIT = new ComposedZi(
            uni("\u6253"), py(Initial.D, Head.OPEN, Body.A, Tail.NONE, Tone.THIRD),
    ...
    public static final ComposedZi PU_POUNCE = new ComposedZi(
            uni("\u6251"), py(Initial.P, Head.U, Body.U, Tail.NONE, Tone.FIRST),
    ...
    public static final ComposedZi BA_RAKE = new ComposedZi(
            uni("\u6252"), py(Initial.B, Head.OPEN, Body.A, Tail.NONE, Tone.FIRST),
    ...
    public static final ComposedZi GONG_MERIT = new ComposedZi(
            uni("\u529F"), py(Initial.G, Head.OPEN, Body.O, Tail.NG, Tone.FIRST),
    ...
    public static final ComposedZi RENG_THROW = new ComposedZi(
            uni("\u6254"), py(Initial.R, Head.OPEN, Body.E, Tail.NG, Tone.FIRST),
    ...
    public static final ComposedZi JIE_FESTIVAL = new ComposedZi(
            uni("\u8282"), py(Initial.J, Head.I, Body.E_CARON, Tail.NONE, Tone.SECOND),
    ...
    public static final ComposedZi LI_STRICT = new ComposedZi(
            uni("\u5389"), py(Initial.L, Head.OPEN, Body.I, Tail.NONE, Tone.FOURTH),
    ...
    public static final ComposedZi MIE_EXTINGUISH = new ComposedZi(
            uni("\u706D"), py(Initial.M, Head.I, Body.E_CARON, Tail.NONE, Tone.FOURTH),
    ...
    public static final ComposedZi YA_CRUSH = new ComposedZi(
            uni("\u8F67"), py(Initial.ZERO, Head.I, Body.A, Tail.NONE, Tone.FOURTH),
    ...
    public static final ComposedZi ZHAN_OCCUPY = new ComposedZi(
            uni("\u5360"), py(Initial.ZH, Head.OPEN, Body.A, Tail.N, Tone.FOURTH),
    ...
    public static final ComposedZi JIU_OLD = new ComposedZi(
            uni("\u65E7"), py(Initial.J, Head.I, Body.O, Tail.VOWEL_U, Tone.FOURTH),
    ...
    public static final ComposedZi DAN_DAWN = new ComposedZi(
            uni("\u65E6"), py(Initial.D, Head.OPEN, Body.A, Tail.N, Tone.FOURTH),
    ...
    public static final ComposedZi YE_LEAF = new ComposedZi(
            uni("\u53F6"), py(Initial.ZERO, Head.I, Body.E_CARON, Tail.NONE, Tone.FOURTH),
    ...
    public static final ComposedZi DING_STING = new ComposedZi(
            uni("\u53EE"), py(Initial.D, Head.OPEN, Body.I, Tail.NG, Tone.FIRST),
    ...
    public static final ComposedZi ZHI_ONLY = new ComposedZi(
            uni("\u53EA"), py(Initial.ZH, Head.OPEN, Body.NULL, Tail.NONE, Tone.THIRD),
    ...
    public static final ComposedZi DIAO_HOLD = new ComposedZi(
            uni("\u53FC"), py(Initial.D, Head.I, Body.A, Tail.VOWEL_U, Tone.FIRST),
    ...
    public static final ComposedZi LING_OTHER = new ComposedZi(
            uni("\u53E6"), py(Initial.L, Head.OPEN, Body.I, Tail.NG, Tone.FOURTH),
    ...
    public static final ComposedZi DAO_CHATTER = new ComposedZi(
            uni("\u53E8"), py(Initial.D, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FIRST),
    ...
    public static final ComposedZi TAN_SIGH = new ComposedZi(
            uni("\u53F9"), py(Initial.T, Head.OPEN, Body.A, Tail.N, Tone.FOURTH),
    ...
    public static final ComposedZi FU_PAY = new ComposedZi(
            uni("\u4ED8"), py(Initial.F, Head.U, Body.U, Tail.NONE, Tone.FOURTH),
    ...
    public static final ComposedZi ZHANG_BATTLE = new ComposedZi(
            uni("\u4ED7"), py(Initial.ZH, Head.OPEN, Body.A, Tail.NG, Tone.FOURTH),
    ...
    public static final ComposedZi DAI_GENERATION = new ComposedZi(
            uni("\u4EE3"), py(Initial.D, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.FOURTH),
    ...
    public static final ComposedZi XIAN_IMMORTAL = new ComposedZi(
            uni("\u4ED9"), py(Initial.X, Head.I, Body.A, Tail.N, Tone.FIRST),
    ...
    public static final ComposedZi MEN_PLURAL = new ComposedZi(
            uni("\u4EEC"), py(Initial.M, Head.OPEN, Body.E, Tail.N, Tone.NEUTRAL),
    ...
    public static final ComposedZi YI_CEREMONY = new ComposedZi(
            uni("\u4EEA"), py(Initial.ZERO, Head.OPEN, Body.I, Tail.NONE, Tone.SECOND),
    ...
    public static final ComposedZi ZAI_CAREFUL = new ComposedZi(
            uni("\u4ED4"), py(Initial.Z, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.THIRD),
    ...
    public static final ComposedZi TA_HE = new ComposedZi(
            uni("\u4ED6"), py(Initial.T, Head.OPEN, Body.A, Tail.NONE, Tone.FIRST),
    ...
    public static final ComposedZi WAI_OUTSIDE = new ComposedZi(
            uni("\u5916"), py(Initial.ZERO, Head.U, Body.A, Tail.VOWEL_I, Tone.FOURTH),
    ...
    public static final ComposedZi JU_SENTENCE = new ComposedZi(
            uni("\u53E5"), py(Initial.J, Head.V, Body.V, Tail.NONE, Tone.FOURTH),
    ...
    public static final ComposedZi BAO_WRAP = new ComposedZi(
            uni("\u5305"), py(Initial.B, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FIRST),
    ...
    public static final ComposedZi JI_HUNGER = new ComposedZi(
            uni("\u9965"), py(Initial.J, Head.OPEN, Body.I, Tail.NONE, Tone.FIRST),
    ...
    public static final ComposedZi SHAN_FLASH = new ComposedZi(
            uni("\u95EA"), py(Initial.SH, Head.OPEN, Body.A, Tail.N, Tone.THIRD),
    ...
    public static final ComposedZi ZHI_JUICE = new ComposedZi(
            uni("\u6C41"), py(Initial.ZH, Head.OPEN, Body.NULL, Tail.NONE, Tone.FIRST),
    ...
    public static final ComposedZi HAN = new ComposedZi(
            uni("\u6C49"), py(Initial.H, Head.OPEN, Body.A, Tail.N, Tone.FOURTH),
    ...
    public static final ComposedZi NING = new ComposedZi(
            uni("\u5B81"), py(Initial.N, Head.OPEN, Body.I, Tail.NG, Tone.SECOND),
    ...
    public static final ComposedZi TA_IT = new ComposedZi(
            uni("\u5B83"), py(Initial.T, Head.OPEN, Body.A, Tail.NONE, Tone.FIRST),
    ...
    public static final ComposedZi TAO_DISCUSS = new ComposedZi(
            uni("\u8BA8"), py(Initial.T, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.THIRD),
    ...
    public static final ComposedZi XIE_WRITE = new ComposedZi(
            uni("\u5199"), py(Initial.X, Head.I, Body.E_CARON, Tail.NONE, Tone.THIRD),
    ...
    public static final ComposedZi RANG_LET = new ComposedZi(
            uni("\u8BA9"), py(Initial.R, Head.OPEN, Body.A, Tail.NG, Tone.FOURTH),
    ...
    public static final ComposedZi LI_CEREMONY = new ComposedZi(
            uni("\u793C"), py(Initial.L, Head.OPEN, Body.I, Tail.NONE, Tone.THIRD),
    ...
    public static final ComposedZi XUN_INSTRUCT = new ComposedZi(
            uni("\u8BAD"), py(Initial.X, Head.V, Body.E, Tail.N, Tone.FOURTH),
    ...
    public static final ComposedZi YI_DISCUSS = new ComposedZi(
            uni("\u8BAE"), py(Initial.ZERO, Head.OPEN, Body.I, Tail.NONE, Tone.FOURTH),
    ...
    public static final ComposedZi JI_RECORD = new ComposedZi(
            uni("\u8BB0"), py(Initial.J, Head.OPEN, Body.I, Tail.NONE, Tone.FOURTH),
    ...
    public static final ComposedZi NI_NUN = new ComposedZi(
            uni("\u5C3C"), py(Initial.N, Head.OPEN, Body.I, Tail.NONE, Tone.SECOND),
    ...
    public static final ComposedZi LIAO = new ComposedZi(
            uni("\u8FBD"), py(Initial.L, Head.I, Body.A, Tail.VOWEL_U, Tone.SECOND),
    ...
    public static final ComposedZi NAI_MILK = new ComposedZi(
            uni("\u5976"), py(Initial.N, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.THIRD),
    ...
    public static final ComposedZi NU_SLAVE = new ComposedZi(
            uni("\u5974"), py(Initial.N, Head.U, Body.U, Tail.NONE, Tone.SECOND),
    ...
    public static final ComposedZi JIA_ADD = new ComposedZi(
            uni("\u52A0"), py(Initial.J, Head.I, Body.A, Tail.NONE, Tone.FIRST),
    ...
    public static final ComposedZi ZHAO_SUMMON = new ComposedZi(
            uni("\u53EC"), py(Initial.ZH, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FOURTH),
    ...
    public static final ComposedZi BIAN_SIDE = new ComposedZi(
            uni("\u8FB9"), py(Initial.B, Head.I, Body.A, Tail.N, Tone.FIRST),
    ...
    public static final ComposedZi SHENG_SAINT = new ComposedZi(
            uni("\u5723"), py(Initial.SH, Head.OPEN, Body.E, Tail.NG, Tone.FOURTH),
    ...
    public static final ComposedZi DUI_CORRECT = new ComposedZi(
            uni("\u5BF9"), py(Initial.D, Head.U, Body.E, Tail.VOWEL_I, Tone.FOURTH),
    ...
    public static final ComposedZi YOU_YOUNG = new ComposedZi(
            uni("\u5E7C"), py(Initial.ZERO, Head.I, Body.O, Tail.VOWEL_U, Tone.FOURTH),
