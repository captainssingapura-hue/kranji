...
public final class Depth1StrokesHigh {
    ...
    public static final ComposedZi MO_WIPE = new ComposedZi(
            lit("\u62B9"), List.of(py(Initial.M, Head.OPEN, Body.O, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi LONG_GATHER = new ComposedZi(
            lit("\u62E2"), List.of(py(Initial.L, Head.OPEN, Body.O, Tail.NG, Tone.THIRD)),
    ...
    public static final ComposedZi YA_PRESS = new ComposedZi(
            lit("\u62BC"), List.of(py(Initial.ZERO, Head.I, Body.A, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi CHOU_DRAW = new ComposedZi(
            lit("\u62BD"), List.of(py(Initial.CH, Head.OPEN, Body.O, Tail.VOWEL_U, Tone.FIRST)),
    ...
    public static final ComposedZi PAI = new ComposedZi(
            lit("\u62CD"), List.of(py(Initial.P, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.FIRST)),
    ...
    public static final ComposedZi BAN_MIX = new ComposedZi(
            lit("\u62CC"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi PI_DRAPE = new ComposedZi(
            lit("\u62AB"), List.of(py(Initial.P, Head.OPEN, Body.I, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi BO_STIR = new ComposedZi(
            lit("\u62E8"), List.of(py(Initial.B, Head.OPEN, Body.O, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi TAI_LIFT = new ComposedZi(
            lit("\u62AC"), List.of(py(Initial.T, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.SECOND)),
    ...
    public static final ComposedZi CHAI = new ComposedZi(
            lit("\u62C6"), List.of(py(Initial.CH, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.FIRST)),
    ...
    public static final ComposedZi MO_FOAM = new ComposedZi(
            lit("\u6CAB"), List.of(py(Initial.M, Head.OPEN, Body.O, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi ZHU_POUR = new ComposedZi(
            lit("\u6CE8"), List.of(py(Initial.ZH, Head.U, Body.U, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi FEI_BOIL = new ComposedZi(
            lit("\u6CB8"), List.of(py(Initial.F, Head.OPEN, Body.E, Tail.VOWEL_I, Tone.FOURTH)),
    ...
    public static final ComposedZi YONG_SWIM = new ComposedZi(
            lit("\u6CF3"), List.of(py(Initial.ZERO, Head.I, Body.O, Tail.NG, Tone.THIRD)),
    ...
    public static final ComposedZi YOU_OIL = new ComposedZi(
            lit("\u6CB9"), List.of(py(Initial.ZERO, Head.I, Body.O, Tail.VOWEL_U, Tone.SECOND)),
    ...
    public static final ComposedZi BO_MOOR = new ComposedZi(
            lit("\u6CCA"), List.of(py(Initial.B, Head.OPEN, Body.O, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi HE_RIVER = new ComposedZi(
            lit("\u6CB3"), List.of(py(Initial.H, Head.OPEN, Body.E, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi LEI_TEAR = new ComposedZi(
            lit("\u6CEA"), List.of(py(Initial.L, Head.OPEN, Body.E, Tail.VOWEL_I, Tone.FOURTH)),
    ...
    public static final ComposedZi BO_WAVE = new ComposedZi(
            lit("\u6CE2"), List.of(py(Initial.B, Head.OPEN, Body.O, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi XIE_LEAK = new ComposedZi(
            lit("\u6CC4"), List.of(py(Initial.X, Head.I, Body.E, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi PO_SPLASH = new ComposedZi(
            lit("\u6CFC"), List.of(py(Initial.P, Head.OPEN, Body.O, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi ZHI_GOVERN = new ComposedZi(
            lit("\u6CBB"), List.of(py(Initial.ZH, Head.OPEN, Body.I, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi FA_LAW = new ComposedZi(
            lit("\u6CD5"), List.of(py(Initial.F, Head.OPEN, Body.A, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi JIE_SISTER = new ComposedZi(
            lit("\u59D0"), List.of(py(Initial.J, Head.I, Body.E, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi SHI_BEGIN = new ComposedZi(
            lit("\u59CB"), List.of(py(Initial.SH, Head.OPEN, Body.I, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi MEI_SISTER = new ComposedZi(
            lit("\u59B9"), List.of(py(Initial.M, Head.OPEN, Body.E, Tail.VOWEL_I, Tone.FOURTH)),
    ...
    public static final ComposedZi XING_SURNAME = new ComposedZi(
            lit("\u59D3"), List.of(py(Initial.X, Head.OPEN, Body.I, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi XING_NATURE = new ComposedZi(
            lit("\u6027"), List.of(py(Initial.X, Head.OPEN, Body.I, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi PA_FEAR = new ComposedZi(
            lit("\u6015"), List.of(py(Initial.P, Head.OPEN, Body.A, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi LIAN_PITY = new ComposedZi(
            lit("\u601C"), List.of(py(Initial.L, Head.I, Body.A, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi BI_THAT = new ComposedZi(
            lit("\u5F7C"), List.of(py(Initial.B, Head.OPEN, Body.I, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi WANG_GO = new ComposedZi(
            lit("\u5F80"), List.of(py(Initial.ZERO, Head.U, Body.A, Tail.NG, Tone.THIRD)),
    ...
    public static final ComposedZi ZHONG_END = new ComposedZi(
            lit("\u7EC8"), List.of(py(Initial.ZH, Head.OPEN, Body.O, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi XI_THIN = new ComposedZi(
            lit("\u7EC6"), List.of(py(Initial.X, Head.OPEN, Body.I, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi ZU_GROUP = new ComposedZi(
            lit("\u7EC4"), List.of(py(Initial.Z, Head.U, Body.U, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi PENG = new ComposedZi(
            lit("\u670B"), List.of(py(Initial.P, Head.OPEN, Body.E, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi ZHONG_SWOLLEN = new ComposedZi(
            lit("\u80BF"), List.of(py(Initial.ZH, Head.OPEN, Body.O, Tail.NG, Tone.THIRD)),
    ...
    public static final ComposedZi ZHI_LIMB = new ComposedZi(
            lit("\u80A2"), List.of(py(Initial.ZH, Head.OPEN, Body.I, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi FEI_FAT = new ComposedZi(
            lit("\u80A5"), List.of(py(Initial.F, Head.OPEN, Body.E, Tail.VOWEL_I, Tone.SECOND)),
    ...
    public static final ComposedZi DAO_ARRIVE = new ComposedZi(
            lit("\u5230"), List.of(py(Initial.D, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi FANG_RELEASE = new ComposedZi(
            lit("\u653E"), List.of(py(Initial.F, Head.OPEN, Body.A, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi QU_TAKE = new ComposedZi(
            lit("\u53D6"), List.of(py(Initial.Q, Head.V, Body.V, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi GU_LONELY = new ComposedZi(
            lit("\u5B64"), List.of(py(Initial.G, Head.U, Body.U, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi OU = new ComposedZi(
            lit("\u6B27"), List.of(py(Initial.ZERO, Head.OPEN, Body.O, Tail.VOWEL_U, Tone.FIRST)),
    ...
    public static final ComposedZi ZHAN_CHOP = new ComposedZi(
            lit("\u65A9"), List.of(py(Initial.ZH, Head.OPEN, Body.A, Tail.N, Tone.THIRD)),
    ...
    public static final ComposedZi RUAN = new ComposedZi(
            lit("\u8F6F"), List.of(py(Initial.R, Head.U, Body.A, Tail.N, Tone.THIRD)),
    ...
    public static final ComposedZi ZHI_NEPHEW = new ComposedZi(
            lit("\u4F84"), List.of(py(Initial.ZH, Head.OPEN, Body.I, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi GONG_SUPPLY = new ComposedZi(
            lit("\u4F9B"), List.of(py(Initial.G, Head.OPEN, Body.O, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi WU_THING = new ComposedZi(
            lit("\u7269"), List.of(py(Initial.ZERO, Head.U, Body.U, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi MU_HERD = new ComposedZi(
            lit("\u7267"), List.of(py(Initial.M, Head.U, Body.U, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi KUANG_ORE = new ComposedZi(
            lit("\u77FF"), List.of(py(Initial.K, Head.U, Body.A, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi MA_CODE = new ComposedZi(
            lit("\u7801"), List.of(py(Initial.M, Head.OPEN, Body.A, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi ZHI_KNOW = new ComposedZi(
            lit("\u77E5"), List.of(py(Initial.ZH, Head.OPEN, Body.I, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi BAI_DEFEAT = new ComposedZi(
            lit("\u8D25"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.FOURTH)),
    ...
    public static final ComposedZi HU_FOX = new ComposedZi(
            lit("\u72D0"), List.of(py(Initial.H, Head.U, Body.U, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi SUO_PLACE = new ComposedZi(
            lit("\u6240"), List.of(py(Initial.S, Head.U, Body.O, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi PO_SLOPE = new ComposedZi(
            lit("\u5761"), List.of(py(Initial.P, Head.OPEN, Body.O, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi WEI_TASTE = new ComposedZi(
            lit("\u5473"), List.of(py(Initial.ZERO, Head.U, Body.E, Tail.VOWEL_I, Tone.FOURTH)),
    ...
    public static final ComposedZi YONG_CHANT = new ComposedZi(
            lit("\u548F"), List.of(py(Initial.ZERO, Head.I, Body.O, Tail.NG, Tone.THIRD)),
    ...
    public static final ComposedZi MING_CRY = new ComposedZi(
            lit("\u9E23"), List.of(py(Initial.M, Head.OPEN, Body.I, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi ZHU_STATION = new ComposedZi(
            lit("\u9A7B"), List.of(py(Initial.ZH, Head.U, Body.U, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi SHI_LOOK = new ComposedZi(
            lit("\u89C6"), List.of(py(Initial.SH, Head.OPEN, Body.I, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi DIAO_FISH = new ComposedZi(
            lit("\u9493"), List.of(py(Initial.D, Head.I, Body.A, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi WANG_FLOURISH = new ComposedZi(
            lit("\u65FA"), List.of(py(Initial.ZERO, Head.U, Body.A, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi SHAN_SHIRT = new ComposedZi(
            lit("\u886B"), List.of(py(Initial.SH, Head.OPEN, Body.A, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi SHAN_SHAANXI = new ComposedZi(
            lit("\u9655"), List.of(py(Initial.SH, Head.OPEN, Body.A, Tail.N, Tone.THIRD)),
    ...
    public static final ComposedZi XIAN_LIMIT = new ComposedZi(
            lit("\u9650"), List.of(py(Initial.X, Head.I, Body.A, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi JIAO_SUBURB = new ComposedZi(
            lit("\u90CA"), List.of(py(Initial.J, Head.I, Body.A, Tail.VOWEL_U, Tone.FIRST)),
    ...
    public static final ComposedZi LUN_WHEEL = new ComposedZi(
            lit("\u8F6E"), List.of(py(Initial.L, Head.U, Body.E, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi QI_STRANGE = new ComposedZi(
            lit("\u5947"), List.of(py(Initial.Q, Head.OPEN, Body.I, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi FEN_EXERT = new ComposedZi(
            lit("\u594B"), List.of(py(Initial.F, Head.OPEN, Body.E, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi JI_SEASON = new ComposedZi(
            lit("\u5B63"), List.of(py(Initial.J, Head.OPEN, Body.I, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi WEI_ENTRUST = new ComposedZi(
            lit("\u59D4"), List.of(py(Initial.ZERO, Head.U, Body.E, Tail.VOWEL_I, Tone.THIRD)),
    ...
    public static final ComposedZi ZONG_CLAN = new ComposedZi(
            lit("\u5B97"), List.of(py(Initial.Z, Head.OPEN, Body.O, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi ZHOU_COSMOS = new ComposedZi(
            lit("\u5B99"), List.of(py(Initial.ZH, Head.OPEN, Body.O, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi YI_FITTING = new ComposedZi(
            lit("\u5B9C"), List.of(py(Initial.ZERO, Head.OPEN, Body.I, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi BAO_TREASURE = new ComposedZi(
            lit("\u5B9D"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.THIRD)),
    ...
    public static final ComposedZi SHEN_EXAMINE = new ComposedZi(
            lit("\u5BA1"), List.of(py(Initial.SH, Head.OPEN, Body.E, Tail.N, Tone.THIRD)),
    ...
    public static final ComposedZi KONG = new ComposedZi(
            lit("\u7A7A"), List.of(py(Initial.K, Head.OPEN, Body.O, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi YAN_ROCK = new ComposedZi(
            lit("\u5CA9"), List.of(py(Initial.ZERO, Head.I, Body.A, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi ZHONG_LOYAL = new ComposedZi(
            lit("\u5FE0"), List.of(py(Initial.ZH, Head.OPEN, Body.O, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi HU_SUDDENLY = new ComposedZi(
            lit("\u603D"), List.of(py(Initial.H, Head.U, Body.U, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi MANG_BLIND = new ComposedZi(
            lit("\u76F2"), List.of(py(Initial.M, Head.OPEN, Body.A, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi FU_AXE = new ComposedZi(
            lit("\u65A7"), List.of(py(Initial.F, Head.U, Body.U, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi YAN_FLAME = new ComposedZi(
            lit("\u708E"), List.of(py(Initial.ZERO, Head.I, Body.A, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi KUN = new ComposedZi(
            lit("\u6606"), List.of(py(Initial.K, Head.U, Body.E, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi JIAN_SHOULDER = new ComposedZi(
            lit("\u80A9"), List.of(py(Initial.J, Head.I, Body.A, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi PING_APPLE = new ComposedZi(
            lit("\u82F9"), List.of(py(Initial.P, Head.OPEN, Body.I, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi MIAO_SEEDLING = new ComposedZi(
            lit("\u82D7"), List.of(py(Initial.M, Head.I, Body.A, Tail.VOWEL_U, Tone.SECOND)),
    ...
    public static final ComposedZi YING_HERO = new ComposedZi(
            lit("\u82F1"), List.of(py(Initial.ZERO, Head.OPEN, Body.I, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi RUO = new ComposedZi(
            lit("\u82E5"), List.of(py(Initial.R, Head.U, Body.O, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi MAO_THATCH = new ComposedZi(
            lit("\u8305"), List.of(py(Initial.M, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.SECOND)),
    ...
    public static final ComposedZi NIAN_THINK = new ComposedZi(
            lit("\u5FF5"), List.of(py(Initial.N, Head.I, Body.A, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi TAN_GREEDY = new ComposedZi(
            lit("\u8D2A"), List.of(py(Initial.T, Head.OPEN, Body.A, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi HUO_GOODS = new ComposedZi(
            lit("\u8D27"), List.of(py(Initial.H, Head.U, Body.O, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi PO_PRESS = new ComposedZi(
            lit("\u8FEB"), List.of(py(Initial.P, Head.OPEN, Body.O, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi FANG_ROOM = new ComposedZi(
            lit("\u623F"), List.of(py(Initial.F, Head.OPEN, Body.A, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi JIE_SESSION = new ComposedZi(
            lit("\u5C4A"), List.of(py(Initial.J, Head.I, Body.E, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi QU_BEND = new ComposedZi(
            lit("\u5C48"), List.of(py(Initial.Q, Head.V, Body.V, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi ZHI_TWIG = new ComposedZi(
            lit("\u679D"), List.of(py(Initial.ZH, Head.OPEN, Body.I, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi BEI_CUP = new ComposedZi(
            lit("\u676F"), List.of(py(Initial.B, Head.OPEN, Body.E, Tail.VOWEL_I, Tone.FIRST)),
    ...
    public static final ComposedZi XI_ANALYZE = new ComposedZi(
            lit("\u6790"), List.of(py(Initial.X, Head.OPEN, Body.I, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi QIANG_GUN = new ComposedZi(
            lit("\u67AA"), List.of(py(Initial.Q, Head.I, Body.A, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi GUI_CABINET = new ComposedZi(
            lit("\u67DC"), List.of(py(Initial.G, Head.U, Body.E, Tail.VOWEL_I, Tone.FOURTH)),
    ...
    public static final ComposedZi GAN_STRAW = new ComposedZi(
            lit("\u79C6"), List.of(py(Initial.G, Head.OPEN, Body.A, Tail.N, Tone.THIRD)),
    ...
    public static final ComposedZi HE_HARMONY = new ComposedZi(
            lit("\u548C"), List.of(py(Initial.H, Head.OPEN, Body.E, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi KU_BITTER = new ComposedZi(
            lit("\u82E6"), List.of(py(Initial.K, Head.U, Body.U, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi GU_SOLID = new ComposedZi(
            lit("\u56FA"), List.of(py(Initial.G, Head.U, Body.U, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi TU_MAP = new ComposedZi(
            lit("\u56FE"), List.of(py(Initial.T, Head.U, Body.U, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi ZHA_SLUICE = new ComposedZi(
            lit("\u95F8"), List.of(py(Initial.ZH, Head.OPEN, Body.A, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi NAO_NOISY = new ComposedZi(
            lit("\u95F9"), List.of(py(Initial.N, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi CHANG_PROSPER = new ComposedZi(
            lit("\u660C"), List.of(py(Initial.CH, Head.OPEN, Body.A, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi TAI_ATTITUDE = new ComposedZi(
            lit("\u6001"), List.of(py(Initial.T, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.FOURTH)),
    ...
    public static final ComposedZi HUN_DUSK = new ComposedZi(
            lit("\u660F"), List.of(py(Initial.H, Head.U, Body.E, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi BA_DAD = new ComposedZi(
            lit("\u7238"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi LONG_RIDGE = new ComposedZi(
            lit("\u5784"), List.of(py(Initial.L, Head.OPEN, Body.O, Tail.NG, Tone.THIRD)),
    ...
    public static final ComposedZi LIAN_CURTAIN = new ComposedZi(
            lit("\u5E18"), List.of(py(Initial.L, Head.I, Body.A, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi HUA_SPEECH = new ComposedZi(
            lit("\u8BDD"), List.of(py(Initial.H, Head.U, Body.A, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi GAI_SHOULD = new ComposedZi(
            lit("\u8BE5"), List.of(py(Initial.G, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.FIRST)),
    ...
    public static final ComposedZi XIANG_DETAIL = new ComposedZi(
            lit("\u8BE6"), List.of(py(Initial.X, Head.I, Body.A, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi SHI_USE = new ComposedZi(
            lit("\u4F7F"), List.of(py(Initial.SH, Head.OPEN, Body.I, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi YI_RELY = new ComposedZi(
            lit("\u4F9D"), List.of(py(Initial.ZERO, Head.OPEN, Body.I, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi CHAO_STIRFRY = new ComposedZi(
            lit("\u7092"), List.of(py(Initial.CH, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.THIRD)),
    ...
    public static final ComposedZi CHUI_COOK = new ComposedZi(
            lit("\u7094"), List.of(py(Initial.CH, Head.U, Body.E, Tail.VOWEL_I, Tone.FIRST)),
    ...
    public static final ComposedZi LU_STOVE = new ComposedZi(
            lit("\u7089"), List.of(py(Initial.L, Head.U, Body.U, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi CHEN_LINING = new ComposedZi(
            lit("\u886C"), List.of(py(Initial.CH, Head.OPEN, Body.E, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi HU_CALL = new ComposedZi(
            lit("\u547C"), List.of(py(Initial.H, Head.U, Body.U, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi GUA_SCRAPE = new ComposedZi(
            lit("\u522E"), List.of(py(Initial.G, Head.U, Body.A, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi XIN_JOY = new ComposedZi(
            lit("\u6B23"), List.of(py(Initial.X, Head.OPEN, Body.I, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi LA_PULL = new ComposedZi(
            lit("\u62C9"), List.of(py(Initial.L, Head.OPEN, Body.A, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi LAN_BLOCK = new ComposedZi(
            lit("\u62E6"), List.of(py(Initial.L, Head.OPEN, Body.A, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi YONG_EMBRACE = new ComposedZi(
            lit("\u62E5"), List.of(py(Initial.ZERO, Head.I, Body.O, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi GU_AUNT = new ComposedZi(
            lit("\u59D1"), List.of(py(Initial.G, Head.U, Body.U, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi SHI_DRIVE = new ComposedZi(
            lit("\u9A76"), List.of(py(Initial.SH, Head.OPEN, Body.I, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi ZHUAN_TURN = new ComposedZi(
            lit("\u8F6C"), List.of(py(Initial.ZH, Head.U, Body.A, Tail.N, Tone.THIRD)),
    ...
    public static final ComposedZi DING_TOP = new ComposedZi(
            lit("\u9876"), List.of(py(Initial.D, Head.OPEN, Body.I, Tail.NG, Tone.THIRD)),
    ...
    public static final ComposedZi ZHENG_EXPEDITION = new ComposedZi(
            lit("\u5F81"), List.of(py(Initial.ZH, Head.OPEN, Body.E, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi FU_SKIN = new ComposedZi(
            lit("\u80A4"), List.of(py(Initial.F, Head.U, Body.U, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi LA_GARBAGE = new ComposedZi(
            lit("\u5783"), List.of(py(Initial.L, Head.OPEN, Body.A, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi GUI_RULE = new ComposedZi(
            lit("\u89C4"), List.of(py(Initial.G, Head.U, Body.E, Tail.VOWEL_I, Tone.FIRST)),
    ...
    public static final ComposedZi XIAN_APPEAR = new ComposedZi(
            lit("\u73B0"), List.of(py(Initial.X, Head.I, Body.A, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi HUAN_RING = new ComposedZi(
            lit("\u73AF"), List.of(py(Initial.H, Head.U, Body.A, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi BA_PULL = new ComposedZi(
            lit("\u62D4"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi JING_CLEAN = new ComposedZi(
            lit("\u51C0"), List.of(py(Initial.J, Head.OPEN, Body.I, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi PA_CRAWL = new ComposedZi(
            lit("\u722C"), List.of(py(Initial.P, Head.OPEN, Body.A, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi DI_TARGET = new ComposedZi(
            lit("\u7684"), List.of(py(Initial.D, Head.OPEN, Body.I, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi MIAO_TEMPLE = new ComposedZi(
            lit("\u5E99"), List.of(py(Initial.M, Head.I, Body.A, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi DI_BOTTOM = new ComposedZi(
            lit("\u5E95"), List.of(py(Initial.D, Head.OPEN, Body.I, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi FEI_WASTE = new ComposedZi(
            lit("\u5E9F"), List.of(py(Initial.F, Head.OPEN, Body.E, Tail.VOWEL_I, Tone.FOURTH)),
    ...
    public static final ComposedZi JU_DWELL = new ComposedZi(
            lit("\u5C45"), List.of(py(Initial.J, Head.V, Body.V, Tail.NONE, Tone.FIRST)),
