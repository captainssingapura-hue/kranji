...
public final class Depth1Strokes4 {
    ...
    public static final ComposedZi YUAN = new ComposedZi(
            uni("\u5143"),
            List.of(py(Initial.ZERO, Head.V, Body.A, Tail.N, Tone.SECOND)),
            4, 10, "",
    ...
    public static final ComposedZi GONG_PUBLIC = new ComposedZi(
            uni("\u516C"),
            List.of(py(Initial.G, Head.OPEN, Body.O, Tail.NG, Tone.FIRST)),
            4, 12, "",
    ...
    public static final ComposedZi XIONG_FIERCE = new ComposedZi(
            uni("\u51F6"),
            List.of(py(Initial.X, Head.I, Body.O, Tail.NG, Tone.FIRST)),
            4, 17, "",
    ...
    public static final ComposedZi GANG_RIDGE = new ComposedZi(
            uni("\u5188"),
            List.of(py(Initial.G, Head.OPEN, Body.A, Tail.NG, Tone.FIRST)),
            4, 13, "",
    ...
    public static final ComposedZi SHI_TEN = new ComposedZi(
            uni("\u4EC0"),
            List.of(py(Initial.SH, Head.OPEN, Body.NULL, Tail.NONE, Tone.SECOND)),
            4, 9, "",
    ...
    public static final ComposedZi PU_SERVANT = new ComposedZi(
            uni("\u4EC6"),
            List.of(py(Initial.P, Head.U, Body.U, Tail.NONE, Tone.SECOND)),
            4, 9, "",
    ...
    public static final ComposedZi CHOU_HATRED = new ComposedZi(
            uni("\u4EC7"),
            List.of(py(Initial.CH, Head.OPEN, Body.O, Tail.VOWEL_U, Tone.SECOND)),
            4, 9, "",
    ...
    public static final ComposedZi RENG = new ComposedZi(
            uni("\u4ECD"),
            List.of(py(Initial.R, Head.OPEN, Body.E, Tail.NG, Tone.SECOND)),
            4, 9, "",
    ...
    public static final ComposedZi JIN_ONLY = new ComposedZi(
            uni("\u4EC5"),
            List.of(py(Initial.J, Head.OPEN, Body.I, Tail.N, Tone.THIRD)),
            4, 9, "",
    ...
    public static final ComposedZi CONG_FROM = new ComposedZi(
            uni("\u4ECE"),
            List.of(py(Initial.C, Head.OPEN, Body.O, Tail.NG, Tone.SECOND)),
            4, 9, "",
    ...
    public static final ComposedZi QIE_CUT = new ComposedZi(
            uni("\u5207"),
            List.of(py(Initial.Q, Head.I, Body.E_CARON, Tail.NONE, Tone.FIRST)),
            4, 18, "",
    ...
    public static final ComposedZi FEN = new ComposedZi(
            uni("\u5206"),
            List.of(py(Initial.F, Head.OPEN, Body.E, Tail.N, Tone.FIRST)),
            4, 18, "",
    ...
    public static final ComposedZi SHUANG = new ComposedZi(
            uni("\u53CC"),
            List.of(py(Initial.SH, Head.U, Body.A, Tail.NG, Tone.FIRST)),
            4, 29, "",
    ...
    public static final ComposedZi DING_SUBSCRIBE = new ComposedZi(
            uni("\u8BA2"),
            List.of(py(Initial.D, Head.OPEN, Body.I, Tail.NG, Tone.FOURTH)),
            4, 149, "",
    ...
    public static final ComposedZi JI_PLAN = new ComposedZi(
            uni("\u8BA1"),
            List.of(py(Initial.J, Head.OPEN, Body.I, Tail.NONE, Tone.FOURTH)),
            4, 149, "",
    ...
    public static final ComposedZi REN_RECOGNIZE = new ComposedZi(
            uni("\u8BA4"),
            List.of(py(Initial.R, Head.OPEN, Body.E, Tail.N, Tone.FOURTH)),
            4, 149, "",
    ...
    public static final ComposedZi YIN_PULL = new ComposedZi(
            uni("\u5F15"),
            List.of(py(Initial.ZERO, Head.OPEN, Body.I, Tail.N, Tone.THIRD)),
            4, 57, "",
    ...
    public static final ComposedZi ZHA_TIE = new ComposedZi(
            uni("\u624E"),
            List.of(py(Initial.ZH, Head.OPEN, Body.A, Tail.NONE, Tone.FIRST)),
            4, 64, "",
    ...
    public static final ComposedZi TING_HALL = new ComposedZi(
            uni("\u5385"),
            List.of(py(Initial.T, Head.OPEN, Body.I, Tail.NG, Tone.FIRST)),
            4, 27, "",
    ...
    public static final ComposedZi LI_HISTORY = new ComposedZi(
            uni("\u5386"),
            List.of(py(Initial.L, Head.OPEN, Body.I, Tail.NONE, Tone.FOURTH)),
            4, 27, "",
    ...
    public static final ComposedZi FAN_OPPOSE = new ComposedZi(
            uni("\u53CD"),
            List.of(py(Initial.F, Head.OPEN, Body.A, Tail.N, Tone.THIRD)),
            4, 29, "",
    ...
    public static final ComposedZi QUAN_ADVISE = new ComposedZi(
            uni("\u529D"),
            List.of(py(Initial.Q, Head.V, Body.A, Tail.N, Tone.FOURTH)),
            4, 19, "",
    ...
    public static final ComposedZi DUI_TEAM = new ComposedZi(
            uni("\u961F"),
            List.of(py(Initial.D, Head.U, Body.E, Tail.VOWEL_I, Tone.FOURTH)),
            4, 170, "",
