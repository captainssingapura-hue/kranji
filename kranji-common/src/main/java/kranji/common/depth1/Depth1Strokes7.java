...
public final class Depth1Strokes7 {
    ...
    public static final ComposedZi NONG = new ComposedZi(
            uni("\u5F04"), List.of(py(Initial.N, Head.OPEN, Body.O, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi JIN_ADVANCE = new ComposedZi(
            uni("\u8FDB"), List.of(py(Initial.J, Head.I, Body.NULL, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi JIE_WARN = new ComposedZi(
            uni("\u6212"), List.of(py(Initial.J, Head.I, Body.E, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi TUN_SWALLOW = new ComposedZi(
            uni("\u541E"), List.of(py(Initial.T, Head.U, Body.NULL, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi WEI_VIOLATE = new ComposedZi(
            uni("\u8FDD"), List.of(py(Initial.ZERO, Head.U, Body.E, Tail.VOWEL_I, Tone.SECOND)),
    ...
    public static final ComposedZi YUN_TRANSPORT = new ComposedZi(
            uni("\u8FD0"), List.of(py(Initial.ZERO, Head.U, Body.NULL, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi FU_SUPPORT = new ComposedZi(
            uni("\u6276"), List.of(py(Initial.F, Head.U, Body.NULL, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi FU_STROKE = new ComposedZi(
            uni("\u629A"), List.of(py(Initial.F, Head.U, Body.NULL, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi TAN_ALTAR = new ComposedZi(
            uni("\u575B"), List.of(py(Initial.T, Head.OPEN, Body.A, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi JI_SKILL = new ComposedZi(
            uni("\u6280"), List.of(py(Initial.J, Head.I, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi HUAI = new ComposedZi(
            uni("\u574F"), List.of(py(Initial.H, Head.U, Body.A, Tail.VOWEL_I, Tone.FOURTH)),
    ...
    public static final ComposedZi RAO = new ComposedZi(
            uni("\u6270"), List.of(py(Initial.R, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.THIRD)),
    ...
    public static final ComposedZi JU_REFUSE = new ComposedZi(
            uni("\u62D2"), List.of(py(Initial.J, Head.U, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi ZHAO_FIND = new ComposedZi(
            uni("\u627E"), List.of(py(Initial.ZH, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.THIRD)),
    ...
    public static final ComposedZi PI_BATCH = new ComposedZi(
            uni("\u6279"), List.of(py(Initial.P, Head.I, Body.NULL, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi CHE_PULL = new ComposedZi(
            uni("\u626F"), List.of(py(Initial.CH, Head.OPEN, Body.E, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi ZHI_SITE = new ComposedZi(
            uni("\u5740"), List.of(py(Initial.ZH, Head.OPEN, Body.NULL, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi CHAO_COPY = new ComposedZi(
            uni("\u6284"), List.of(py(Initial.CH, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FIRST)),
    ...
    public static final ComposedZi BA_DAM = new ComposedZi(
            uni("\u575D"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi GONG_TRIBUTE = new ComposedZi(
            uni("\u8D21"), List.of(py(Initial.G, Head.OPEN, Body.O, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi GONG_ATTACK = new ComposedZi(
            uni("\u653B"), List.of(py(Initial.G, Head.OPEN, Body.O, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi ZHE_FOLD = new ComposedZi(
            uni("\u6298"), List.of(py(Initial.ZH, Head.OPEN, Body.E, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi ZHUA_GRAB = new ComposedZi(
            uni("\u6293"), List.of(py(Initial.ZH, Head.U, Body.A, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi QIANG_ROB = new ComposedZi(
            uni("\u62A2"), List.of(py(Initial.Q, Head.I, Body.A, Tail.NG, Tone.THIRD)),
    ...
    public static final ComposedZi XIAO_FILIAL = new ComposedZi(
            uni("\u5B5D"), List.of(py(Initial.X, Head.I, Body.A, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi JUN_EQUAL = new ComposedZi(
            uni("\u5747"), List.of(py(Initial.J, Head.U, Body.NULL, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi PAO_THROW = new ComposedZi(
            uni("\u629B"), List.of(py(Initial.P, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FIRST)),
    ...
    public static final ComposedZi FEN_GRAVE = new ComposedZi(
            uni("\u575F"), List.of(py(Initial.F, Head.OPEN, Body.E, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi KANG_RESIST = new ComposedZi(
            uni("\u6297"), List.of(py(Initial.K, Head.OPEN, Body.A, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi KENG = new ComposedZi(
            uni("\u5751"), List.of(py(Initial.K, Head.OPEN, Body.E, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi FANG_LANE = new ComposedZi(
            uni("\u574A"), List.of(py(Initial.F, Head.OPEN, Body.A, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi DOU_TREMBLE = new ComposedZi(
            uni("\u6296"), List.of(py(Initial.D, Head.OPEN, Body.O, Tail.VOWEL_U, Tone.THIRD)),
    ...
    public static final ComposedZi HU_PROTECT = new ComposedZi(
            uni("\u62A4"), List.of(py(Initial.H, Head.U, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi ZHI_WILL = new ComposedZi(
            uni("\u5FD7"), List.of(py(Initial.ZH, Head.OPEN, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi NIU_TWIST = new ComposedZi(
            uni("\u626D"), List.of(py(Initial.N, Head.I, Body.O, Tail.VOWEL_U, Tone.THIRD)),
    ...
    public static final ComposedZi BA_HOLD = new ComposedZi(
            uni("\u628A"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi BAO_REPORT = new ComposedZi(
            uni("\u62A5"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi QUE = new ComposedZi(
            uni("\u5374"), List.of(py(Initial.Q, Head.U, Body.E, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi JIE_ROB = new ComposedZi(
            uni("\u52AB"), List.of(py(Initial.J, Head.I, Body.E, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi YA_SPROUT = new ComposedZi(
            uni("\u82BD"), List.of(py(Initial.ZERO, Head.OPEN, Body.A, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi QIN_CELERY = new ComposedZi(
            uni("\u82B9"), List.of(py(Initial.Q, Head.I, Body.NULL, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi CANG_PALE = new ComposedZi(
            uni("\u82CD"), List.of(py(Initial.C, Head.OPEN, Body.A, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi FANG_FRAGRANT = new ComposedZi(
            uni("\u82B3"), List.of(py(Initial.F, Head.OPEN, Body.A, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi LU_REED = new ComposedZi(
            uni("\u82A6"), List.of(py(Initial.L, Head.U, Body.NULL, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi LAO = new ComposedZi(
            uni("\u52B3"), List.of(py(Initial.L, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.SECOND)),
    ...
    public static final ComposedZi SU_REVIVE = new ComposedZi(
            uni("\u82CF"), List.of(py(Initial.S, Head.U, Body.NULL, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi GAN_POLE = new ComposedZi(
            uni("\u6746"), List.of(py(Initial.G, Head.OPEN, Body.A, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi GANG_BAR = new ComposedZi(
            uni("\u6760"), List.of(py(Initial.G, Head.OPEN, Body.A, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi DU_BIRCH = new ComposedZi(
            uni("\u675C"), List.of(py(Initial.D, Head.U, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi CAI_MATERIAL = new ComposedZi(
            uni("\u6750"), List.of(py(Initial.C, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.SECOND)),
    ...
    public static final ComposedZi CUN_VILLAGE = new ComposedZi(
            uni("\u6751"), List.of(py(Initial.C, Head.U, Body.NULL, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi JI_EXTREME = new ComposedZi(
            uni("\u6781"), List.of(py(Initial.J, Head.I, Body.NULL, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi FOU = new ComposedZi(
            uni("\u5426"), List.of(py(Initial.F, Head.OPEN, Body.O, Tail.VOWEL_U, Tone.THIRD)),
    ...
    public static final ComposedZi HAI_STILL = new ComposedZi(
            uni("\u8FD8"), List.of(py(Initial.H, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.SECOND)),
    ...
    public static final ComposedZi JIAN_ANNIHILATE = new ComposedZi(
            uni("\u6B7C"), List.of(py(Initial.J, Head.I, Body.A, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi LIAN = new ComposedZi(
            uni("\u8FDE"), List.of(py(Initial.L, Head.I, Body.A, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi HAN_DROUGHT = new ComposedZi(
            uni("\u65F1"), List.of(py(Initial.H, Head.OPEN, Body.A, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi DING_STARE = new ComposedZi(
            uni("\u76EF"), List.of(py(Initial.D, Head.OPEN, Body.I, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi CHENG_PRESENT = new ComposedZi(
            uni("\u5448"), List.of(py(Initial.CH, Head.OPEN, Body.E, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi SHI_TIME = new ComposedZi(
            uni("\u65F6"), List.of(py(Initial.SH, Head.OPEN, Body.NULL, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi WU_SURNAME = new ComposedZi(
            uni("\u5434"), List.of(py(Initial.ZERO, Head.U, Body.NULL, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi ZHU_HELP = new ComposedZi(
            uni("\u52A9"), List.of(py(Initial.ZH, Head.U, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi XIAN_COUNTY = new ComposedZi(
            uni("\u53BF"), List.of(py(Initial.X, Head.I, Body.A, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi KUANG_VAST = new ComposedZi(
            uni("\u65F7"), List.of(py(Initial.K, Head.U, Body.A, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi WEI_SURROUND = new ComposedZi(
            uni("\u56F4"), List.of(py(Initial.ZERO, Head.U, Body.E, Tail.VOWEL_I, Tone.SECOND)),
    ...
    public static final ComposedZi YA_AH = new ComposedZi(
            uni("\u5440"), List.of(py(Initial.ZERO, Head.OPEN, Body.A, Tail.NONE, Tone.NEUTRAL)),
    ...
    public static final ComposedZi DUN_TON = new ComposedZi(
            uni("\u5428"), List.of(py(Initial.D, Head.U, Body.NULL, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi YOU_MAIL = new ComposedZi(
            uni("\u90AE"), List.of(py(Initial.ZERO, Head.I, Body.O, Tail.VOWEL_U, Tone.SECOND)),
    ...
    public static final ComposedZi NAN_MALE = new ComposedZi(
            uni("\u7537"), List.of(py(Initial.N, Head.OPEN, Body.A, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi CHAO_NOISY = new ComposedZi(
            uni("\u5435"), List.of(py(Initial.CH, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.THIRD)),
    ...
    public static final ComposedZi YUAN_MEMBER = new ComposedZi(
            uni("\u5458"), List.of(py(Initial.ZERO, Head.U, Body.A, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi TING_LISTEN = new ComposedZi(
            uni("\u542C"), List.of(py(Initial.T, Head.OPEN, Body.I, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi CHUI_BLOW = new ComposedZi(
            uni("\u5439"), List.of(py(Initial.CH, Head.U, Body.NULL, Tail.VOWEL_I, Tone.FIRST)),
    ...
    public static final ComposedZi WU_WAIL = new ComposedZi(
            uni("\u545C"), List.of(py(Initial.ZERO, Head.U, Body.NULL, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi BA_PARTICLE = new ComposedZi(
            uni("\u5427"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.NONE, Tone.NEUTRAL)),
    ...
    public static final ComposedZi HOU_ROAR = new ComposedZi(
            uni("\u543C"), List.of(py(Initial.H, Head.OPEN, Body.O, Tail.VOWEL_U, Tone.THIRD)),
    ...
    public static final ComposedZi ZHANG_TENT = new ComposedZi(
            uni("\u5E10"), List.of(py(Initial.ZH, Head.OPEN, Body.A, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi CAI_WEALTH = new ComposedZi(
            uni("\u8D22"), List.of(py(Initial.C, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.SECOND)),
    ...
    public static final ComposedZi ZHEN_NEEDLE = new ComposedZi(
            uni("\u9488"), List.of(py(Initial.ZH, Head.OPEN, Body.E, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi DING_NAIL_METAL = new ComposedZi(
            uni("\u9489"), List.of(py(Initial.D, Head.OPEN, Body.I, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi GAO_TELL = new ComposedZi(
            uni("\u544A"), List.of(py(Initial.G, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi LI_PROFIT = new ComposedZi(
            uni("\u5229"), List.of(py(Initial.L, Head.I, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi TU_BALD = new ComposedZi(
            uni("\u79C3"), List.of(py(Initial.T, Head.U, Body.NULL, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi XIU_ELEGANT = new ComposedZi(
            uni("\u79C0"), List.of(py(Initial.X, Head.I, Body.O, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi SI_PRIVATE = new ComposedZi(
            uni("\u79C1"), List.of(py(Initial.S, Head.OPEN, Body.NULL, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi TI_BODY = new ComposedZi(
            uni("\u4F53"), List.of(py(Initial.T, Head.I, Body.NULL, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi HE_WHAT = new ComposedZi(
            uni("\u4F55"), List.of(py(Initial.H, Head.OPEN, Body.E, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi SHEN_STRETCH = new ComposedZi(
            uni("\u4F38"), List.of(py(Initial.SH, Head.OPEN, Body.E, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi ZUO_MAKE = new ComposedZi(
            uni("\u4F5C"), List.of(py(Initial.Z, Head.U, Body.O, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi BO_UNCLE = new ComposedZi(
            uni("\u4F2F"), List.of(py(Initial.B, Head.OPEN, Body.O, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi LING_CLEVER = new ComposedZi(
            uni("\u4F36"), List.of(py(Initial.L, Head.I, Body.NULL, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi YONG_SERVANT = new ComposedZi(
            uni("\u4F63"), List.of(py(Initial.ZERO, Head.I, Body.O, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi DI_LOW = new ComposedZi(
            uni("\u4F4E"), List.of(py(Initial.D, Head.I, Body.NULL, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi NI_YOU = new ComposedZi(
            uni("\u4F60"), List.of(py(Initial.N, Head.I, Body.NULL, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi ZHU_LIVE = new ComposedZi(
            uni("\u4F4F"), List.of(py(Initial.ZH, Head.U, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi WEI_POSITION = new ComposedZi(
            uni("\u4F4D"), List.of(py(Initial.ZERO, Head.U, Body.E, Tail.VOWEL_I, Tone.FOURTH)),
    ...
    public static final ComposedZi BAN_COMPANION = new ComposedZi(
            uni("\u4F34"), List.of(py(Initial.B, Head.OPEN, Body.A, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi ZAO_SOAP = new ComposedZi(
            uni("\u7682"), List.of(py(Initial.Z, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi FO_BUDDHA = new ComposedZi(
            uni("\u4F5B"), List.of(py(Initial.F, Head.OPEN, Body.O, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi JIN_NEAR = new ComposedZi(
            uni("\u8FD1"), List.of(py(Initial.J, Head.I, Body.NULL, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi TUO = new ComposedZi(
            uni("\u59A5"), List.of(py(Initial.T, Head.U, Body.O, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi HAN_CONTAIN = new ComposedZi(
            uni("\u542B"), List.of(py(Initial.H, Head.OPEN, Body.A, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi LIN_NEIGHBOR = new ComposedZi(
            uni("\u90BB"), List.of(py(Initial.L, Head.I, Body.NULL, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi GAN_LIVER = new ComposedZi(
            uni("\u809D"), List.of(py(Initial.G, Head.OPEN, Body.A, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi DU_BELLY = new ComposedZi(
            uni("\u809A"), List.of(py(Initial.D, Head.U, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi KUANG_MAD = new ComposedZi(
            uni("\u72C2"), List.of(py(Initial.K, Head.U, Body.A, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi YOU_STILL = new ComposedZi(
            uni("\u72B9"), List.of(py(Initial.ZERO, Head.I, Body.O, Tail.VOWEL_U, Tone.SECOND)),
    ...
    public static final ComposedZi SHAN_DELETE = new ComposedZi(
            uni("\u5220"), List.of(py(Initial.SH, Head.OPEN, Body.A, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi YING_WELCOME = new ComposedZi(
            uni("\u8FCE"), List.of(py(Initial.ZERO, Head.I, Body.NULL, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi YIN_DRINK = new ComposedZi(
            uni("\u996E"), List.of(py(Initial.ZERO, Head.I, Body.NULL, Tail.N, Tone.THIRD)),
    ...
    public static final ComposedZi DONG_FREEZE = new ComposedZi(
            uni("\u51BB"), List.of(py(Initial.D, Head.OPEN, Body.O, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi ZHUANG_STATE = new ComposedZi(
            uni("\u72B6"), List.of(py(Initial.ZH, Head.U, Body.A, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi KUANG_SITUATION = new ComposedZi(
            uni("\u51B5"), List.of(py(Initial.K, Head.U, Body.A, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi KU_WAREHOUSE = new ComposedZi(
            uni("\u5E93"), List.of(py(Initial.K, Head.U, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi LENG = new ComposedZi(
            uni("\u51B7"), List.of(py(Initial.L, Head.OPEN, Body.E, Tail.NG, Tone.THIRD)),
    ...
    public static final ComposedZi ZHE_THIS = new ComposedZi(
            uni("\u8FD9"), List.of(py(Initial.ZH, Head.OPEN, Body.E, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi XU_ORDER = new ComposedZi(
            uni("\u5E8F"), List.of(py(Initial.X, Head.U, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi YE_SMELT = new ComposedZi(
            uni("\u51B6"), List.of(py(Initial.ZERO, Head.I, Body.E, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi WANG_FORGET = new ComposedZi(
            uni("\u5FD8"), List.of(py(Initial.ZERO, Head.U, Body.A, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi JIAN_BETWEEN = new ComposedZi(
            uni("\u95F4"), List.of(py(Initial.J, Head.I, Body.A, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi MEN_STUFFY = new ComposedZi(
            uni("\u95F7"), List.of(py(Initial.M, Head.OPEN, Body.E, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi PAN_JUDGE = new ComposedZi(
            uni("\u5224"), List.of(py(Initial.P, Head.OPEN, Body.A, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi ZAO_STOVE = new ComposedZi(
            uni("\u7076"), List.of(py(Initial.Z, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi CAN_BRILLIANT = new ComposedZi(
            uni("\u707F"), List.of(py(Initial.C, Head.OPEN, Body.A, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi WANG_VAST = new ComposedZi(
            uni("\u6C6A"), List.of(py(Initial.ZERO, Head.U, Body.A, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi SHA_SAND = new ComposedZi(
            uni("\u6C99"), List.of(py(Initial.SH, Head.OPEN, Body.A, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi QI_STEAM = new ComposedZi(
            uni("\u6C7D"), List.of(py(Initial.Q, Head.I, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi WO_FERTILE = new ComposedZi(
            uni("\u6C83"), List.of(py(Initial.ZERO, Head.U, Body.O, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi FAN_FLOOD = new ComposedZi(
            uni("\u6CDB"), List.of(py(Initial.F, Head.OPEN, Body.A, Tail.N, Tone.FOURTH)),
    ...
    public static final ComposedZi GOU_DITCH = new ComposedZi(
            uni("\u6C9F"), List.of(py(Initial.G, Head.OPEN, Body.O, Tail.VOWEL_U, Tone.FIRST)),
    ...
    public static final ComposedZi SHEN_SINK = new ComposedZi(
            uni("\u6C88"), List.of(py(Initial.SH, Head.OPEN, Body.E, Tail.N, Tone.THIRD)),
    ...
    public static final ComposedZi CHEN_SINK = new ComposedZi(
            uni("\u6C89"), List.of(py(Initial.CH, Head.OPEN, Body.E, Tail.N, Tone.SECOND)),
            7, 85, "", new LeftRight(SAN_DIAN_SHUI, RadicalComponents.YIN_WAVER),
            new PhonoSemantic(SAN_DIAN_SHUI, RadicalComponents.YIN_WAVER));

    /** 怀 (huái) — bosom, cherish. LeftRight: 忄 + 不. */
    public static final ComposedZi HUAI_CHERISH = new ComposedZi(
            uni("\u6000"), List.of(py(Initial.H, Head.U, Body.A, Tail.VOWEL_I, Tone.SECOND)),
    ...
    public static final ComposedZi YOU_WORRY = new ComposedZi(
            uni("\u5FE7"), List.of(py(Initial.ZERO, Head.I, Body.O, Tail.VOWEL_U, Tone.FIRST)),
    ...
    public static final ComposedZi LAO_PRISON = new ComposedZi(
            uni("\u7262"), List.of(py(Initial.L, Head.OPEN, Body.A, Tail.VOWEL_U, Tone.SECOND)),
    ...
    public static final ComposedZi JIU_INVESTIGATE = new ComposedZi(
            uni("\u7A76"), List.of(py(Initial.J, Head.I, Body.O, Tail.VOWEL_U, Tone.FIRST)),
    ...
    public static final ComposedZi QIONG = new ComposedZi(
            uni("\u7A77"), List.of(py(Initial.Q, Head.I, Body.O, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi ZAI_DISASTER = new ComposedZi(
            uni("\u707E"), List.of(py(Initial.Z, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.FIRST)),
    ...
    public static final ComposedZi ZHENG_PROVE = new ComposedZi(
            uni("\u8BC1"), List.of(py(Initial.ZH, Head.OPEN, Body.E, Tail.NG, Tone.FOURTH)),
    ...
    public static final ComposedZi QI_START = new ComposedZi(
            uni("\u542F"), List.of(py(Initial.Q, Head.I, Body.NULL, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi PING_EVALUATE = new ComposedZi(
            uni("\u8BC4"), List.of(py(Initial.P, Head.I, Body.NULL, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi BU_MEND = new ComposedZi(
            uni("\u8865"), List.of(py(Initial.B, Head.U, Body.NULL, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi CHU_INITIAL = new ComposedZi(
            uni("\u521D"), List.of(py(Initial.CH, Head.U, Body.NULL, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi SHE_SOCIETY = new ComposedZi(
            uni("\u793E"), List.of(py(Initial.SH, Head.OPEN, Body.E, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi SU_TELL = new ComposedZi(
            uni("\u8BC9"), List.of(py(Initial.S, Head.U, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi CI_WORD = new ComposedZi(
            uni("\u8BCD"), List.of(py(Initial.C, Head.OPEN, Body.NULL, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi LING_SPIRIT = new ComposedZi(
            uni("\u7075"), List.of(py(Initial.L, Head.I, Body.NULL, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi CENG = new ComposedZi(
            uni("\u5C42"), List.of(py(Initial.C, Head.OPEN, Body.E, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi NIAO_URINE = new ComposedZi(
            uni("\u5C3F"), List.of(py(Initial.N, Head.I, Body.A, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi WEI_TAIL = new ComposedZi(
            uni("\u5C3E"), List.of(py(Initial.ZERO, Head.U, Body.E, Tail.VOWEL_I, Tone.THIRD)),
    ...
    public static final ComposedZi CHI_LATE = new ComposedZi(
            uni("\u8FDF"), List.of(py(Initial.CH, Head.OPEN, Body.NULL, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi GAI_CHANGE = new ComposedZi(
            uni("\u6539"), List.of(py(Initial.G, Head.OPEN, Body.A, Tail.VOWEL_I, Tone.THIRD)),
    ...
    public static final ComposedZi ZHANG_STRETCH = new ComposedZi(
            uni("\u5F20"), List.of(py(Initial.ZH, Head.OPEN, Body.A, Tail.NG, Tone.FIRST)),
    ...
    public static final ComposedZi JI_TABOO = new ComposedZi(
            uni("\u5FCC"), List.of(py(Initial.J, Head.I, Body.NULL, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi A_PREFIX = new ComposedZi(
            uni("\u963F"), List.of(py(Initial.ZERO, Head.OPEN, Body.A, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi CHEN_DISPLAY = new ComposedZi(
            uni("\u9648"), List.of(py(Initial.CH, Head.OPEN, Body.E, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi ZU_BLOCK = new ComposedZi(
            uni("\u963B"), List.of(py(Initial.Z, Head.U, Body.NULL, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi MIAO = new ComposedZi(
            uni("\u5999"), List.of(py(Initial.M, Head.I, Body.A, Tail.VOWEL_U, Tone.FOURTH)),
    ...
    public static final ComposedZi YAO_MONSTER = new ComposedZi(
            uni("\u5996"), List.of(py(Initial.ZERO, Head.I, Body.A, Tail.VOWEL_U, Tone.FIRST)),
    ...
    public static final ComposedZi FANG_HINDER = new ComposedZi(
            uni("\u59A8"), List.of(py(Initial.F, Head.OPEN, Body.A, Tail.NG, Tone.SECOND)),
    ...
    public static final ComposedZi REN_ENDURE = new ComposedZi(
            uni("\u5FCD"), List.of(py(Initial.R, Head.OPEN, Body.E, Tail.N, Tone.THIRD)),
    ...
    public static final ComposedZi JI_CHICKEN = new ComposedZi(
            uni("\u9E21"), List.of(py(Initial.J, Head.I, Body.NULL, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi QU_DRIVE = new ComposedZi(
            uni("\u9A71"), List.of(py(Initial.Q, Head.U, Body.NULL, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi CHUN_PURE = new ComposedZi(
            uni("\u7EAF"), List.of(py(Initial.CH, Head.U, Body.NULL, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi SHA_YARN = new ComposedZi(
            uni("\u7EB1"), List.of(py(Initial.SH, Head.OPEN, Body.A, Tail.NONE, Tone.FIRST)),
    ...
    public static final ComposedZi NA_ACCEPT = new ComposedZi(
            uni("\u7EB3"), List.of(py(Initial.N, Head.OPEN, Body.A, Tail.NONE, Tone.FOURTH)),
    ...
    public static final ComposedZi ZHI_PAPER = new ComposedZi(
            uni("\u7EB8"), List.of(py(Initial.ZH, Head.OPEN, Body.NULL, Tail.NONE, Tone.THIRD)),
    ...
    public static final ComposedZi WEN_PATTERN = new ComposedZi(
            uni("\u7EB9"), List.of(py(Initial.ZERO, Head.U, Body.E, Tail.N, Tone.SECOND)),
    ...
    public static final ComposedZi FANG_SPIN = new ComposedZi(
            uni("\u7EBA"), List.of(py(Initial.F, Head.OPEN, Body.A, Tail.NG, Tone.THIRD)),
    ...
    public static final ComposedZi LV_DONKEY = new ComposedZi(
            uni("\u9A74"), List.of(py(Initial.L, Head.V, Body.NULL, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi NIU_BUTTON = new ComposedZi(
            uni("\u7EBD"), List.of(py(Initial.N, Head.I, Body.O, Tail.VOWEL_U, Tone.THIRD)),
    ...
    public static final ComposedZi JIAN_FIRM = new ComposedZi(
            uni("\u575A"), List.of(py(Initial.J, Head.I, Body.A, Tail.N, Tone.FIRST)),
    ...
    public static final ComposedZi BO_REFUTE = new ComposedZi(
            uni("\u9A73"), List.of(py(Initial.B, Head.OPEN, Body.O, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi BIE = new ComposedZi(
            uni("\u522B"), List.of(py(Initial.B, Head.I, Body.E, Tail.NONE, Tone.SECOND)),
    ...
    public static final ComposedZi ZHEN_DIAGNOSE = new ComposedZi(
            uni("\u8BCA"), List.of(py(Initial.ZH, Head.OPEN, Body.E, Tail.N, Tone.THIRD)),
    ...
    public static final ComposedZi YI_MEDICINE = new ComposedZi(
            uni("\u533B"), List.of(py(Initial.ZERO, Head.I, Body.NULL, Tail.NONE, Tone.FIRST)),
