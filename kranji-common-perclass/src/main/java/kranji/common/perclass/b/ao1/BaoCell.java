...
public record BaoCell() implements ComposedZiT, LeftRightT<Yue, BaoWrap> {

    public static final BaoCell INSTANCE = new BaoCell();
    ...
    @Override public String glyph() { return "\u80DE"; }
    ...
    @Override public EtymologicalCategory etymology() {
        return new EtymologicalCategory.PhonoSemantic(NatureElements.YUE, BaoWrap.INSTANCE);
    }
}
