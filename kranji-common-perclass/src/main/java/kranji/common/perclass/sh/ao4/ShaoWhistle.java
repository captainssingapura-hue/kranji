...
public record ShaoWhistle() implements ComposedZiT, LeftRightT<Kou, Xiao_Resemble> {

    public static final ShaoWhistle INSTANCE = new ShaoWhistle();
    ...
    @Override public String glyph() { return "\u54E8"; }
    ...
    @Override public EtymologicalCategory etymology() {
        return new EtymologicalCategory.PhonoSemantic(BodyParts.KOU, UnsureSingulars.XIAO_RESEMBLE);
    }
}
