...
package kranji.common.perclass.l.iao1;
...
public record LiaoLift() implements ComposedZiT, LeftRightT<TiShouPang, Liao_Torch> {

    public static final LiaoLift INSTANCE = new LiaoLift();
    ...
    @Override public String glyph() { return "\u64A9"; }

    @Override public PinyinSyllable pinyin() {
        return new PinyinSyllable(Initial.L, new Final(Head.I, Body.A, Tail.VOWEL_U), Tone.FIRST);
    }
    ...
    @Override public EtymologicalCategory etymology() {
        return new EtymologicalCategory.PhonoSemantic(BasicComponents.TI_SHOU_PANG, UnsureSingulars.LIAO_TORCH);
    }
}
