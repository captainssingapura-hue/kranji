...
/**
 * 独体字 / 偏旁 — An atomic building block of Chinese characters.
 *
 ...
 */
public interface SingularZi extends Zi {
     ...
     * and the bound role. Note: HintedComponent is a layout wrapper,
     * not a Zi.</p>
     *
    ...
    /**
     * Create a plain SingularZi with no position-specific hints.
     * Used for glyphs that don't yet have a dedicated record.
     */
    static SingularZi plain(String glyph) {
