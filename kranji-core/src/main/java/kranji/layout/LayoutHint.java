...
public record LayoutHint(BlockHint bh, InnerPositionHint iph, Glyph glyph) {
     ...
     */
    public record Glyph(String value, SingularBlock source, SvgShape svg) {
        ...
        public Glyph(String value, SingularBlock source) { this(value, source, null); }
    ...
    public static LayoutHint glyph(String value, SingularBlock source) {
