...
public final class EarFamily {
    ...
    public record ZuoErPang() implements LibraryMember<BasicSet>, kranji.zi.SingularPart {
    ...
    public record YouErPang() implements LibraryMember<BasicSet>, kranji.zi.SingularPart {
        @Override public String glyph()      { return "阝"; }
