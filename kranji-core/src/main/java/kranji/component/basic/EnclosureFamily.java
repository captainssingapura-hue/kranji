...
public final class EnclosureFamily {
    ...
    /** 囗 — 国字框 (enclosure). */
    public record GuoZiKuang() implements LibraryMember<BasicSet>, kranji.zi.SingularPart {
    ...
    /** 疒 — 病字旁 (sickness). */
    public record BingZiPang() implements LibraryMember<BasicSet>, kranji.zi.SingularPart {
    ...
    /** 勹 — 包字头 (wrap). */
    public record BaoZiTou() implements LibraryMember<BasicSet>, kranji.zi.SingularPart {
        ...
        @Override public String pinyinText()     { return "bāo"; }
        @Override public int strokes()       { return 2; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }

    /** 匚 — 三框 (box/container). */
    public record SanKuang() implements LibraryMember<BasicSet>, kranji.zi.SingularPart {
    ...
    /** 凵 — 凶字框 (receptacle). */
    public record XiongZiKuang() implements LibraryMember<BasicSet>, kranji.zi.SingularPart {
        ...
        @Override public String pinyinText()     { return "kǎn"; }
        @Override public int strokes()       { return 2; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }

    /** 冂 — 同字框 (border/boundary). */
    public record TongZiKuang() implements LibraryMember<BasicSet>, kranji.zi.SingularPart {
        ...
        @Override public String pinyinText()     { return "jiōng"; }
        @Override public int strokes()       { return 2; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }
