...
public final class ShelterFamily {
    ...
    /** 宀 — 宝盖头 (roof/shelter). */
    public record BaoGaiTou() implements LibraryMember<BasicSet> {
    ...
    /** 冖 — 秃宝盖 (cover). */
    public record TuBaoGai() implements LibraryMember<BasicSet> {
    ...
    /** 亠 — 文字头 (lid). */
    public record WenZiTou() implements LibraryMember<BasicSet> {
