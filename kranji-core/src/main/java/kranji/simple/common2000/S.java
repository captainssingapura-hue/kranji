...
/** Characters whose default reading begins with {@code s-}. Seed set. */
public final class S {

    private static final SimpleZiDsl D = SimpleZiDsl.forInitial(Initial.S);

    private S() {}

    public static final List<SyllableDecl> DECLARATIONS = List.of(
            D.syl(AN, FIRST, "三"),
            D.syl(SYLLABIC, FOURTH, "四")
    );
}
