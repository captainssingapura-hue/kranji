...
public final class RadicalComponents {
    ...
    public record Yin_Hook() implements LibraryMember<BasicSet> {
    ...
    public record Dao_Top() implements LibraryMember<BasicSet> {
    ...
    public record Xiao_Top() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u2E8C"; }
    ...
    public record Shang_Dot() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u2E8D"; }
    ...
    public record Qiang_Left() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u4E2C"; }
        @Override public String meaning() { return "half-tree left radical"; }
        @Override public String pinyin()  { return "qi\u00E1ng"; }
        @Override public int strokes()    { return 3; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }
    public static final Qiang_Left QIANG_LEFT = new Qiang_Left();

    public record Niu_Left() implements LibraryMember<BasicSet> {
    ...
    public record Mu_Variant() implements LibraryMember<BasicSet> {
    ...
    public record Tu_Old() implements LibraryMember<BasicSet> {
    ...
    public record Wu_Cross() implements LibraryMember<BasicSet> {
    ...
    public record Yan_Marsh() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u3563"; }
        @Override public String meaning() { return "marsh, swamp"; }
        @Override public String pinyin()  { return "y\u01CEn"; }
        @Override public int strokes()    { return 5; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }
    public static final Yan_Marsh YAN_MARSH = new Yan_Marsh();

    public record Yan_Flag() implements LibraryMember<BasicSet> {
    ...
    public record Gan_Shield() implements LibraryMember<BasicSet> {
    ...
    public record Jie_Seal() implements LibraryMember<BasicSet> {
    ...
    public record Si_Private() implements LibraryMember<BasicSet> {
    ...
    public record Chu_Step() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u4E8D"; }
        @Override public String meaning() { return "step with right foot"; }
        @Override public String pinyin()  { return "ch\u00F9"; }
        @Override public int strokes()    { return 3; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }
    public static final Chu_Step CHU_STEP = new Chu_Step();

    public record Zhi_Slow() implements LibraryMember<BasicSet> {
    ...
    public record Shu_Lance() implements LibraryMember<BasicSet> {
    ...
    public record Lao_Top() implements LibraryMember<BasicSet> {
    ...
    public record Hu_Tiger() implements LibraryMember<BasicSet> {
    ...
    public record Xi_Cover() implements LibraryMember<BasicSet> {
    ...
    public record Zhao_Claw() implements LibraryMember<BasicSet> {
    ...
    public record Mao_Cap() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u5183"; }
        @Override public String meaning() { return "cap, hat cover"; }
        @Override public String pinyin()  { return "m\u00E0o"; }
        @Override public int strokes()    { return 4; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }
    public static final Mao_Cap MAO_CAP = new Mao_Cap();

    public record Ran_Whiskers() implements LibraryMember<BasicSet> {
    ...
    public record Yin_Waver() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u5198"; }
        @Override public String meaning() { return "waver, hesitate"; }
        @Override public String pinyin()  { return "y\u00EDn"; }
        @Override public int strokes()    { return 5; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }
    ...
    public record Zhu_Drum() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u58F4"; }
        @Override public String meaning() { return "drum, display"; }
        @Override public String pinyin()  { return "zh\u00F9"; }
        @Override public int strokes()    { return 7; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }
    public static final Zhu_Drum ZHU_DRUM = new Zhu_Drum();

    public record Jing_Stream() implements LibraryMember<BasicSet> {
    ...
    public record Jian_Firm() implements LibraryMember<BasicSet> {
    ...
    public record Xian_Pit() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u81FD"; }
        @Override public String meaning() { return "pit, pitfall"; }
        @Override public String pinyin()  { return "xi\u00E0n"; }
        @Override public int strokes()    { return 6; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }
    public static final Xian_Pit XIAN_PIT = new Xian_Pit();

    public record Cha_Spade() implements LibraryMember<BasicSet> {
    ...
    public record Fu_Full() implements LibraryMember<BasicSet> {
    ...
    public record Shen_Deep() implements LibraryMember<BasicSet> {
    ...
    public record Shu_Erect() implements LibraryMember<BasicSet> {
    ...
    public record Ci_Thorn() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u673F"; }
        @Override public String meaning() { return "thorn, prick"; }
        @Override public String pinyin()  { return "c\u00EC"; }
        @Override public int strokes()    { return 6; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }
    public static final Ci_Thorn CI_THORN = new Ci_Thorn();

    public record Yang_Bright() implements LibraryMember<BasicSet> {
    ...
    public record Qi_Lacquer() implements LibraryMember<BasicSet> {
    ...
    public record Zhu_Top() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u9FB6"; }
        @Override public String meaning() { return "top of \u4E3B/\u751F"; }
        @Override public String pinyin()  { return "zh\u01D4"; }
        @Override public int strokes()    { return 5; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }
    public static final Zhu_Top ZHU_TOP = new Zhu_Top();

    public record Quan_Upper() implements LibraryMember<BasicSet> {
    ...
    public record Gan_Upper() implements LibraryMember<BasicSet> {
    ...
    public record Zuo_Hand() implements LibraryMember<BasicSet> {
    ...
    public record Hua_Stroke() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\uD840\uDC89"; }
        @Override public String meaning() { return "slanting stroke"; }
        @Override public String pinyin()  { return "hu\u00E0"; }
        @Override public int strokes()    { return 2; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }
    public static final Hua_Stroke HUA_STROKE = new Hua_Stroke();

    public record Xia_Hook() implements LibraryMember<BasicSet> {
    ...
    public record Ji_Person() implements LibraryMember<BasicSet> {
    ...
    public record Zhi_Arrive() implements LibraryMember<BasicSet> {
    ...
    public record Yu_Feather() implements LibraryMember<BasicSet> {
    ...
    public record Shi_Show() implements LibraryMember<BasicSet> {
    ...
    public record Liang_Good() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u826F"; }
        @Override public String meaning() { return "good, fine"; }
        @Override public String pinyin()  { return "li\u00E1ng"; }
        @Override public int strokes()    { return 7; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }
    public static final Liang_Good LIANG_GOOD = new Liang_Good();

    public record Fei_Wrong() implements LibraryMember<BasicSet> {
    ...
    public record Niu_Top() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u2EA7"; }
    ...
    public record Yi_Turn() implements LibraryMember<BasicSet> {
    ...
    public record Shui_Variant() implements LibraryMember<BasicSet> {
    ...
    public record Wang_Net() implements LibraryMember<BasicSet> {
        @Override public String glyph()   { return "\u7F52"; }
        @Override public String meaning() { return "net radical top"; }
        @Override public String pinyin()  { return "w\u01CEng"; }
        @Override public int strokes()    { return 5; }
        @Override public BasicSet library() { return BasicSet.INSTANCE; }
    }
    public static final Wang_Net WANG_NET = new Wang_Net();

    public record Ji_Not() implements LibraryMember<BasicSet> {
